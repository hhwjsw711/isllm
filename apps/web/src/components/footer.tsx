  ...
  return (
    <footer className="border-t-[1px] border-border px-4 md:px-6 pt-10 md:pt-16 bg-[#fff] dark:bg-[#0C0C0C] overflow-hidden md:max-h-[820px]">
      <div className="container">
        <div className="flex justify-around items-center gap-8 border-border border-b-[1px] pb-10 md:pb-16 mb-12">
          <Link href="/" className="scale-180 -ml-[30px] md:ml-0 md:scale-100">
            <Image
              src="/logos/fizz.svg"
              alt="FizzDragon Logo"
              height={60}
